...
wind = pm.window( 'TheRiggersToolkitX',t = 'RigToolkitX',w=300,h=330,s=0,bgc = [(.17),(.18),(.19)])
Tab = tabLayout('Tabs',p='TheRiggersToolkitX',tc =1,stb=0,snt=1,ntc = 'NewTab()')
...
cmdShll = cmds.cmdShell(p='MelCmd',w=285,h=230 , bgc = [(.17),(.18),(.19)])
...
channelbox = pm.channelBox('Channels',p = 'Tabs',ac = [(.8),(.9),(1)],bc = [(.3),(.3),(.3)],ekf =1,fw=150,hlc=[(.2),(.6),(.4)],hol =1,ln=1,nn=0,m=1,pre = 5,)
